    ...
    methods: {
        actualizarGraficoMedianteSelect(){
            if (this.opcionSelecionada === 'medico') {
                axios.get('http://127.0.0.1:8000/get_curanilahue_medico/')
                .then(response => {
                ...
                axios.get('http://127.0.0.1:8000/get_curanilahue_industrial/')
                .then(response => {
                    data_grafico = { 'bueno': 0, 'regular': 0, 'malo': 0, 'baja': 0 }
                    data_grafico_barra = { 'critico': 0, 'relevante': 0 }
                    vida_util_residual = 0
                ...
                axios.get('http://127.0.0.1:8000/get_curanilahue_vehiculos/')
                .then(response => {
                    data_grafico = { 'bueno': 0, 'regular': 0, 'malo': 0, 'baja': 0 }
                    data_grafico_barra = { 'critico': 0, 'relevante': 0 }
                    vida_util_residual = 0
        ...
        data_inicial(){
            axios('http://127.0.0.1:8000/get_curanilahue_medico/')
            .then(response => {
                data_grafico = { 'bueno': 0, 'regular': 0, 'malo': 0, 'baja': 0 }
                data_grafico_barra = { 'critico': 0, 'relevante': 0 }
                vida_util_residual = 0
